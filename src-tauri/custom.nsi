...
Section "Install CH340 Driver"
  ; Set the output path to the directory where the drivers will be extracted
  DetailPrint "Setting output path to: $INSTDIR\drivers\CH340"
  ...
  DetailPrint "System architecture detected: $R0"
  
  StrCmp $R0 "AMD64" 0 +3
    DetailPrint "64-bit system detected, installing 64-bit driver..."
    ExecWait '"$INSTDIR\drivers\CH340\CH34164.EXE" /S' $0
    DetailPrint "64-bit driver installation exit code: $0"
    Goto done
  
  DetailPrint "32-bit system detected, installing 32-bit driver..."
  ExecWait '"$INSTDIR\drivers\CH340\CH34032.EXE" /S' $0
  DetailPrint "32-bit driver installation exit code: $0"
